    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <c:forEach var="list" items="${machinepage.content}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/admin/query/queryPage?machineid=${list.machineid}"  class="btn btn-default" data-toggle="dialog" data-width="900" data-height="580" data-id="dialog-mask" data-mask="true">详情</a>
            </tr>
        </c:forEach>
        </tbody>
    </table>
